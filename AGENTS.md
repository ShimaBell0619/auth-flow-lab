...
- Use the Foundation v0.9.2 context-routed Chat implementation method for material work: Repository Context Packet (session-local only), Design Intent, Implementation Map, coherent write batch, focused/full validation, self-review, correction, re-review, final validation.
